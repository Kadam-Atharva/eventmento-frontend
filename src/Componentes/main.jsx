                ...
                {auth.isAuthenticated ? (
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-medium text-gray-700">
                      Hi, {auth.user?.profile.preferred_username || "User"}
                    </span>
                    <button
        ...
        <section className="py-20 md:py-32">
          <div className="container mx-auto px-4 text-center max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              The easiest way to plan, organize, and execute your events. Focus
              on creating memorable experiences, not managing spreadsheets.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-blue-50/60 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-md transition border border-blue-100">
                ...
                <p className="text-gray-600">
                  Streamline your timeline with our intuitive drag-and-drop
                  calendar interface.
                </p>
              </div>
              {/* Feature 2 */}
              <div className="bg-blue-50/60 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-md transition border border-blue-100">
                ...
                <p className="text-gray-600">
                  Keep track of RSVPs, ticket sales, and guest preferences all
                  in one place.
                </p>
              </div>
              {/* Feature 3 */}
              <div className="bg-blue-50/60 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-md transition border border-blue-100">
                ...
                <p className="text-gray-600">
                  Get insights into your event performance with detailed,
                  real-time reports.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-50/60 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-sm border border-blue-100">
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-100 focus:border-blue-400 outline-none transition cursor-none"
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="px-8 py-3 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition w-full md:w-auto cursor-none"
                  >
                    Send Message
                  </button>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Making event management effortless for organizers and memorable
                for attendees.
              </p>
            </div>
            {/* Links */}
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                ...
                <li className="pt-4 flex space-x-4">
                  <a
                    href="#"
                    className="text-gray-400 hover:text-white transition cursor-none"
                  >
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center bg-gray-900">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} EventMento. All rights reserved.
            </p>
            <div className="flex space-x-6 text-sm text-gray-500">
              <a href="#" className="hover:text-white transition cursor-none">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-white transition cursor-none">
                Terms of Service
